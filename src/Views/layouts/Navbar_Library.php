                ...
                <div class="playlist_option_menu">
                    <ul class="playlist_option__List_Menu">
                        <li class="playlist_option__Item_Menu"><a
                                class="playlist_option__Item_Menu__Link " href="http://localhost:81/spotify/Library">Playlists</a></li>
                        <li class="playlist_option__Item_Menu"><a class="playlist_option__Item_Menu__Link"
                                href="http://localhost:81/spotify/Library/podcast">Podcasts</a></li>
                        <li class="playlist_option__Item_Menu"><a class="playlist_option__Item_Menu__Link"
                                href="http://localhost:81/spotify/Library/artist">Artists</a></li>
                        <li class="playlist_option__Item_Menu "><a class="playlist_option__Item_Menu__Link"
                                href="http://localhost:81/spotify/Library/album">Albums</a></li>
                    </ul>
                </div>
