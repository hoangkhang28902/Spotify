    ...
    <nav class="navSidebar">
        <div class="navMain">
            ...
            <ul class="navDashboard"> 
                ...
                <li>
                    <a href="<?php echo PAGEROOT ?>/Search" class="nav-link" onclick="navigateTo('<?php echo PAGEROOT ?>/search')">
                ...
                <li>
                    <a href="<?php echo PAGEROOT ?>/Library" class="nav-link" onclick="navigateTo('<?php echo PAGEROOT ?>/library')">
