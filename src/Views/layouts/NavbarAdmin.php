...
<div class="navigation">    
            <ul>
                ...
                <li>
                    <a href="http://localhost:8080/Spotify/SongAdmin/index" id="input-product">
                        <span class="icon"><i class="fa fa-music" aria-hidden="true"></i></span>
                        <span class="title">Song</span>
                    </a>
                </li>
                <li>
                    <a href="http://localhost:8080/Spotify/AlbumAdmin/index" >
                ...
                <li>
                    <a href="http://localhost:8080/Spotify/PodcastAdmin/index">
                        <span class="icon"><i class="fa fa-podcast" aria-hidden="true"></i></span>
                        <span class="title">Podcast</span>
                    </a>
                </li>
                   <li>
                    <a href="http://localhost:8080/Spotify/ArtistAdmin/index">
                        <span class="icon"><i class="fa fa-podcast" aria-hidden="true"></i></span>
                        <span class="title">Artist</span>
                    </a>
                </li>
                <li>
                    <a href="http://localhost:8080/Spotify/UserAdmin/index">
                        <span class="icon"><i class="fa fa-users" aria-hidden="true"></i></span>
                        <span class="title">User</span>
                    </a>
                </li>
                <li>
                    <a href="http://localhost:8080/Spotify/PlaylistAdmin/index">
                        <span class="icon"><i class="fa fa-list" aria-hidden="true"></i></span>
                        <span class="title">Playlist</span>
                    </a>
                </li>
                     <li>
                    <a href="http://localhost:8080/Spotify/AdminController/index">
                        <span class="icon"><i class="fa fa-line-chart" aria-hidden="true"></i></span>
