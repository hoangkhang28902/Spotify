            ...
            <div class="d-grid gap-3 main-panel">
                    ...
                    <button type="button" class="btn btn-primary rounded-pill button-custom">
                        <div class="d-flex justify-content-center align-items-center">
                            <svg role="img" height="24" width="24" aria-hidden="true" viewBox="0 0 24 24"
                                data-encore-id="icon" fill="currentColor" class="icon-button">
                                <path
                    ...
                    <button type="button" class="btn btn-outline-secondary rounded-pill button-custom">
                        <div class="d-flex justify-content-center align-items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor"
                                class="bi bi-google icon-button" viewBox="0 0 16 16">
                                <path
                ...
                <form action="#">
                    <div class="mb-3">
                        ...
                        <small id="helpId" class="text-muted"><a href="#" class="text-success">Use phone number
                                instead.</a></small>
                    </div>
                    <div class="mb-3">
                        <label for="cofirmEmail" class="form-label fw-bold">Cofirm your email</label>
                        <input type="email" class="form-control input-custom" name="cofirmEmail" id="cofirmEmail"
                            placeholder="Enter your email again." />
                    </div>
                    <div class="mb-3">
                        <label for="password" class="form-label fw-bold">Create a password</label>
                        <div class="input-group">
                            <input type="password" class="form-control border-end-0 input-custom" name="password"
                                id="password" placeholder="Create a password." />
                            <span class="input-group-text bg-white border-start-0" id="eye-icon">
                                <svg role="img" height="24" width="24" aria-hidden="true" viewBox="0 0 24 24"
                                    data-encore-id="icon" class="opacity-50" onclick="showPassword()">
                                    <path
                    ...
                    <div class="mb-3">
                        <label for="" class="form-label fw-bold">What should we call you?</label>
                        <input type="text" name="" id="" class="form-control input-custom"
                            placeholder="Enter a profile name." aria-describedby="helpId">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="d-flex justify-content-between gap-3">
                            <div class="d-block col">
                                <span>Day</span>
                                <input type="text" aria-invalid="false" id="day" inputmode="numeric" maxlength="2"
                                    name="day" pattern="((0?[1-9])|([12][0-9])|(3[01]))" placeholder="DD" required=""
                                    value="" data-encore-id="formInput" class="form-control mt-2 input-custom">
                            </div>
                            <div class="d-block col-6">
                                <span>Month</span>
                                <select id="month" name="month" required="" aria-invalid="false"
                                    class="form-select mt-2 input-custom">
                            ...
                            <div class="d-block col">
                                <span>Year</span>
                                <input type="text" aria-invalid="false" id="year" inputmode="numeric" maxlength="4"
                                    name="year" pattern="(19[0-9]{2})|(200)[0-9]|(201)[0-0]" placeholder="YYYY"
                                    required="" value="" data-encore-id="formInput"
                                    class="form-control mt-2 input-custom">
                            </div>
                        </div>
                    </div>
                    <div class="mb-5">
                        ...
                        <div class="form-check form-check-inline me-4 mt-2">
                            <input class="form-check-input radio-custom" type="radio" name="gender" id="male"
                                value="male">
                            <label class="form-check-label" for="male">Male</label>
                        </div>
                        <div class="form-check form-check-inline me-4 mt-2">
                            <input class="form-check-input radio-custom" type="radio" name="gender" id="female"
                                value="female">
                            <label class="form-check-label" for="Female">Female</label>
                        </div>
                        <div class="form-check form-check-inline me-4 mt-2">
                            <input class="form-check-input radio-custom" type="radio" name="gender" id="non-binary"
                                value="non-binary">
                            <label class="form-check-label" for="non-binary">Non-binary</label>
                        </div>
                        <div class="form-check form-check-inline me-4 mt-2">
                            <input class="form-check-input radio-custom" type="radio" name="gender" id="other"
                                value="other">
                            <label class="form-check-label" for="other">Other</label>
                        </div>
                        <div class="form-check form-check-inline me-4 mt-2">
                            <input class="form-check-input radio-custom" type="radio" name="gender" id="prefernottosay"
                    ...
                    <div class="mb-3">
                        <div class="d-flex flex-column gap-3">
                            ...
                            <div class="d-grid gap-2">
                                <span class="bottom-text">By clicking on sign-up, you agree to Spotify's <a
                                        href="https://www.spotify.com/vn-vi/legal/end-user-agreement/"
                                        class="text-success">Terms and Conditions of Use</a>.</span>
                                <span class="bottom-text">To learn more about how Spotify collects, uses, shares and
                                    protects your personal data, please see <a
                                        href="https://www.spotify.com/vn-vi/legal/privacy-policy/"
                                        class="text-success">Spotify's Privacy Policy</a>.</span>
                                <div class="d-flex justify-content-center">
                                    <button type="button"
                                        class="btn btn-success rounded-pill text-uppercase fw-bold button-signup">
                                        Sign up
                                    </button>
                                </div>
                            </div>
                ...
                <span class="d-flex justify-content-center pb-3 fw-bold">Have an account?&nbsp;<a href="login.html"
                        class="text-success">Log in</a>.</span>
            </div>
        </div>
    </div>
