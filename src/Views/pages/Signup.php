    ...
    <div class="container-fluid">
        ...
        <div class="d-flex justify-content-center">
            <div class="d-grid gap-3 main-panel">
                ...
                <form action="/Spotify/user/signup" method="post">
                    <div class="mb-3">
                        <label for="email" class="form-label fw-bold">What's your email?</label>
                        <input type="text" name="email" id="email" class="form-control input-custom" placeholder="Enter your email." aria-describedby="helpId">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="d-flex justify-content-between gap-3">
                            <div class="d-block col">
                                <span>Day</span>
                                <input type="text" aria-invalid="false" id="day" inputmode="numeric" maxlength="2" name="day" pattern="((0?[1-9])|([12][0-9])|(3[01]))" placeholder="DD" required="" value="" data-encore-id="formInput" class="form-control mt-2 input-custom">
                            </div>
                            <div class="d-block col-6">
                                <span>Month</span>
                                <select id="month" name="month" required="" aria-invalid="false" class="form-select mt-2 input-custom">
                            ...
                            <div class="d-block col">
                                <span>Year</span>
                                <input type="text" aria-invalid="false" id="year" inputmode="numeric" maxlength="4" name="year" pattern="(19[0-9]{2})|(200)[0-9]|(201)[0-0]" placeholder="YYYY" required="" value="" data-encore-id="formInput" class="form-control mt-2 input-custom">
                            </div>
                        </div>
                    </div>
                    <div class="mb-5">
