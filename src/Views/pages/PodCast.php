    ...
    <span class="playlist_content__button">Find podcasts</span>
     ...
     <div class="propose_ambum">
        <div class="Title_amblu">
            <a class="Title_amblu__TopAmbum" href="http://localhost:81/spotify/topAlbum">Top podcasts</a>
            <a class="Title_amblu__ShowAll" href="http://localhost:81/spotify/topAlbum">Show all</a>
        </div>
        ...
        <div class="Trending_abum">
          ...
          <!-- ******************************       1 Item của spotify  *****************************************-->
      <a href="http://localhost:81/spotify/Podcastcomponent" class="link_btn_img"><div class="CardLibrary_container">
