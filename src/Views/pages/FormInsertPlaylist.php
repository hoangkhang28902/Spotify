...
<body>
	<div class="container mt-5">
		<div class="row">
			...
			<a href="index" class="btn btn-warning" style="margin-bottom:20px; margin-left:200px; position:absolute; margin-top:582px; left: -4%;">Quay về </a>
			...
			<form action="create" method="post" enctype="multipart/form-data">
				...
				?>
						<script>
							...
							window.location.replace("http://localhost:81/Spotify-main/PlaylistAdmin");
						</script>
					<?php
					} else {
					?>
