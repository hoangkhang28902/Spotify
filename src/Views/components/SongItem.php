<?php
function SongItem($num, $image, $name, $singer, $album, $date, $time)
{ ?>
    <div class="row g2 py-2 align-items-center rounded">
        <div class="col-sm-1">
            <div class="num opacity-75"><?php echo $num ?></div>
            <div class="play-icon">
                <svg role="img" height="16" width="16" aria-hidden="true" viewBox="0 0 24 24" data-encore-id="icon" fill="white">
